...
<div class="container mt-4">
    ...
    <form id="pageForm">
        ...
        <div class="mb-3">
            ...
            <textarea id="meta_description" name="meta_description" class="form-control" rows="3" required></textarea>
        </div>
        <div class="mb-3">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#pageForm').on('submit', function (e) {
            ...
            $.ajax({
                url: 'http://localhost:8000/api/pages/store', // Replace with your API URL
                type: 'POST',
                data: formData,
